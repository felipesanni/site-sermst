...
export const localidades: Localidade[] = [
  ...
  },
  {
    ...
    contextoEmpresarial:
      "Setor de serviços avancados. Saúde ocupacional orientada a prevenção, compliance e fluidez operacional para empresas de São Caetano.",
  },
  {
    nome: "Diadema",
    slug: "diadema",
    ...
    adjetivo: "diademense",
    contextoEmpresarial:
      "Polo metal mecanico e quimico. Especialistas em exames complementares, PGR e documentação de SST para industrias em Diadema.",
  },
  {
    nome: "Osasco",
    slug: "osasco",
  ...
  },
  {
    ...
    contextoEmpresarial:
      "Centro logistico aeroportuario nacional. Medicina do trabalho focada em transporte, logística e operações intensivas em Guarulhos.",
  },
  {
    nome: "Barueri",
    slug: "barueri",
    ...
    contextoEmpresarial:
      "Polo corporativo de Alphaville e Tambore. ASO expresso, laudos digitais e organizacao de SST para empresas em crescimento.",
  },
];
...
export const servicosSEO: Record<string, SEODocument> = {
  ...
  "pgr-nr01-gerenciamento-riscos": {
    ...
    quandoRequerido:
      "O PGR e a base da gestão de riscos ocupacionais prevista pela NR-01. Ele deve refletir a operação real da empresa e ser revisto quando houver mudancas relevantes em processo, estrutura, layout ou exposicao ocupacional.",
    content: {
      dor:
  ...
  "gestao-esocial-s2220-s2240": {
    ...
    geoOpt: {
      ...
      faq: [
        ...
        {
          q: "E o evento S-2240?",
          a: "E o evento de condicoes ambientais do trabalho, ligado a exposicao a riscos e base técnica de SST.",
        },
      ],
    },
  },
      ...
      faq: [
        {
          ...
          a: "O exame costuma levar cerca de 15 a 20 minutos por colaborador, dependendo do fluxo e das condicoes de repouso auditivo.",
        },
        {
