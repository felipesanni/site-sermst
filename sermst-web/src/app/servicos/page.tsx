      ...
      <section className="mx-auto w-full max-w-[1280px] px-6 pt-16 pb-4 lg:px-8">
        <div className="max-w-3xl">
          ...
          <p className="mt-4 leading-relaxed text-slate-600">
            Para empresas com motoristas ou para pessoa física que busca{' '}
            <Link href="/servicos/exame-toxicologico-clt/sao-paulo" className="font-bold text-brand-900 underline decoration-accent-pink/40 underline-offset-4 hover:text-accent-pink">
              exame toxicológico para renovação de CNH C, D e E
            </Link>
            , a SERMST também atende com fluxo claro, validade nacional e preço de referência informado na página.
          </p>
        </div>
      </section>

      <section className="mx-auto w-full max-w-[1280px] px-6 py-20 lg:px-8">
        <div className="mb-8 rounded-[2rem] border border-accent-pink/20 bg-gradient-to-r from-accent-pink/6 via-white to-accent-pink/10 p-6 shadow-sm">
          <div className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
            <div className="max-w-3xl">
              ...
              <p className="mt-3 text-sm leading-relaxed text-slate-600">
                Página dedicada para quem busca onde fazer exame toxicológico, entender o valor e resolver demandas de admissão, demissão ou renovação da habilitação com mais clareza.
              </p>
            </div>
            <Link href="/servicos/exame-toxicologico-clt/sao-paulo" className="btn-primary-safe w-full lg:w-auto">
              Ver exame toxicológico
            </Link>
          </div>
        </div>
