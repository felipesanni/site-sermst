          ...
          <FadeIn>
            <div className="max-w-4xl">
              ...
              <div className="flex flex-col gap-5 sm:flex-row">
                <a
                  href={`https://wa.me/5511915146447?text=Quero orçamento para ${servicoNome} em ${local.nome}`}
          ...
          <div className="grid gap-16 lg:grid-cols-2">
            ...
            <FadeIn direction="left" delay={0.2}>
              <div className="flex h-full flex-col justify-center rounded-[2.5rem] bg-brand-900 p-10 text-white shadow-2xl">
                ...
                <a href={`https://wa.me/5511915146447?text=Quero orçamento para ${servicoNome} em ${local.nome}`} className="btn-primary-safe-lg px-10 py-5 text-center text-lg font-black uppercase tracking-tighter shadow-xl">
                  Falar com comercial
                </a>
              </div>
            </FadeIn>
          ...
          <div className="mx-auto max-w-[1280px] px-6">
            <FadeIn className="mb-16 text-center">
              ...
              <p className="mx-auto mt-4 max-w-2xl text-xl font-medium text-slate-500">
                Clique na norma para ver a carga horária e o conteúdo programatico completo.
              </p>
            </FadeIn>
