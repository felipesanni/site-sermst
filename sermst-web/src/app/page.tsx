      ...
      <section className="relative flex min-h-[560px] w-full items-center overflow-hidden bg-brand-900 py-12 lg:min-h-[680px]">
        ...
        <div className="relative z-10 mx-auto flex w-full max-w-[1280px] flex-col items-center justify-between gap-10 px-6 lg:flex-row lg:px-8">
          <div className="w-full max-w-2xl text-center lg:text-left">
            <div className="mb-6 inline-flex items-center gap-3 rounded-full border border-white/10 bg-white/5 py-1.5 pl-1.5 pr-4 shadow-xl backdrop-blur-md md:mb-8">
            ...
            <h1 className="mb-5 text-[2.7rem] font-black leading-[1.04] tracking-tight text-white drop-shadow-[0_10px_20px_rgba(0,0,0,0.75)] sm:text-5xl md:text-6xl lg:text-[5rem]">
              SST não é custo.
            ...
            <p className="mx-auto mb-8 max-w-2xl rounded-xl bg-brand-900/35 p-5 text-lg font-medium leading-relaxed text-slate-200 backdrop-blur-sm md:bg-transparent md:p-0 md:text-xl md:backdrop-blur-none lg:mx-0 lg:border-l-[3px] lg:border-accent-pink lg:pl-6">
          ...
          <div className="hidden w-full max-w-sm lg:block">
            <div className="relative overflow-hidden rounded-[2rem] border border-white/20 bg-white/10 p-8 text-center shadow-[0_30px_60px_-15px_rgba(0,0,0,0.5)] backdrop-blur-xl">
