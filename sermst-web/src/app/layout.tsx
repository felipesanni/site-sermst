          ...
          <div className="mx-auto w-full max-w-[1280px] px-6 lg:px-8">
            <div className="hidden h-20 items-center justify-between md:flex">
              ...
              <div className="hidden items-center gap-2 text-slate-500 lg:flex">
                ...
                <a href="https://www.linkedin.com/company/sermst-gestão-ocupacional" aria-label="LinkedIn" target="_blank" rel="noopener noreferrer" className="social-hover hover-li flex h-8 w-8 items-center justify-center rounded-full bg-slate-100 transition-colors">
