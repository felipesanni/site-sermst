          ...
          body: (
            <>
              <p>
                ...
                <a href="/rh/calculadora-cnae-grau-de-risco" className="font-semibold underline">calculadora CNAE</a>.
              </p>
              ...
              <p className="mt-3 text-xs text-slate-500">
                Fonte: Quadro I da NR-04. Tabela com {cnaeData.length} subclasses CNAE. Para a lista completa com mais de 1.300 subclasses, consulte o IBGE ou a Receita Federal.
              </p>
            </>
          ),
        },
