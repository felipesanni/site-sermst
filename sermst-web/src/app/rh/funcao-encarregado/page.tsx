...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 2, name: 'RH e Departamento Pessoal', item: 'https://sermst.com.br/rh' },
    { '@type': 'ListItem', position: 3, name: 'Função e responsabilidades do encarregado', item: 'https://sermst.com.br/rh/funcao-encarregado' },
  ],
};
