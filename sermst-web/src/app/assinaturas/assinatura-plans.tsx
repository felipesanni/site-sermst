...
const employeeShortcuts = [1, 5, 10, 20, 50, 70, 100, 300, 500, 1000];
...
const orderedPlans = [...plans].sort((a, b) => a.minimum - b.minimum);
  ...
  return (
    <section id="planos" className="bg-slate-50 px-6 py-20 lg:px-8">
      <div className="mx-auto max-w-[1280px]">
        <div className="mb-10 w-full max-w-none">
          ...
          <p className="text-lg leading-relaxed text-slate-600">
            Informe o CNPJ e a quantidade de funcionários para calcular o valor e avançar com a contratação.
          </p>
        </div>
              ...
              <div className="mb-6 border-y border-slate-100 py-6" aria-live="polite">
                {isCommercialQuote ? (
                  ...
                  <>
                    ...
                    <p className="mt-2 text-sm leading-relaxed text-slate-500">
                      {formatter.format(plan.perEmployee)} por funcionário ou{' '}
                      <strong className="text-brand-900">{formatter.format(plan.annualPix)} à vista</strong>
                    </p>
                    <div className="mt-3 inline-flex items-center gap-2 rounded-full border border-accent-pink/20 bg-accent-pink/10 px-3 py-1.5 text-xs font-black uppercase tracking-[0.12em] text-accent-pink">
                      <span className="rounded-full bg-accent-pink px-2 py-0.5 text-[11px] text-white">5% OFF</span>
                      Pagamento à vista
                    </div>
                  </>
                )}
