    ...
    <BlockbusterArticle
      ...
      sections={[
        {
          ...
          body: (
            <>
              ...
              <p>
                Quem pesquisa onde fazer normalmente está mais próximo da decisão do que parece. O que falta, na maioria dos casos, é encontrar uma clínica que deixe claro para quem atende, como funciona e se o laudo serve para a finalidade buscada — sem que o usuário precise ligar para perguntar o básico.
              </p>
            </>
          ),
        },
        ...
        },
        {
          ...
          body: (
            <ol>
              ...
              <li><strong>Preço transparente.</strong> Clínica que exibe o valor com clareza facilita a decisão. Quem não encontra o preço tende a buscar outro lugar sem sequer entrar em contato.</li>
        ...
        },
        {
          ...
          body: (
            <>
              ...
              <p>
                Quando esses pontos aparecem cedo, o visitante percebe rapidamente se aquela clínica atende o caso dele. Isso reduz dúvidas e torna a decisão de entrar em contato muito mais direta.
              </p>
            </>
          ),
        },
      ...
      faq={[
        ...
        },
        {
          ...
          a: 'O preço de referência informado pela SERMST para realização do exame toxicológico é R$ 200,00. O valor completo e o contexto de atendimento estão disponíveis na página principal do serviço.',
        },
        {
          q: 'Posso contratar o exame toxicológico diretamente pela SERMST?',
          a: 'Sim. A SERMST atende tanto empresa quanto pessoa física para exame toxicológico em São Paulo. O próximo passo é acessar a página principal do serviço ou entrar em contato diretamente com a equipe.',
        },
        {
          q: 'Como entrar em contato com a SERMST para o exame toxicológico?',
          a: 'O contato pode ser feito pela página principal do exame toxicológico, que reúne os detalhes de atendimento, preço de referência e o caminho para falar diretamente com a equipe.',
        },
      ]}
