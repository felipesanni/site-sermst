        ...
        <FadeIn direction="up" delay={0.08}>
          <div className="mb-14 grid gap-6 lg:grid-cols-2">
            <div className="rounded-[2rem] border border-slate-200 bg-white p-8 shadow-sm">
              <span className="mb-4 block text-xs font-black uppercase tracking-[0.2em] text-accent-pink">
                Cluster exame toxicológico
              </span>
              <h2 className="text-3xl font-black text-brand-900 md:text-4xl">
                Onde fazer exame toxicológico em São Paulo
              </h2>
              <p className="mt-4 text-lg font-medium leading-relaxed text-slate-700">
                Para quem quer entender onde fazer, quem atende empresa e pessoa física e quando vale avançar para a página principal do serviço.
              </p>
              <Link
            ...
            <div className="rounded-[2rem] border border-slate-200 bg-white p-8 shadow-sm">
              ...
              <p className="mt-4 text-lg font-medium leading-relaxed text-slate-700">
                Para capturar a dúvida de preço sem canibalizar a página principal, com foco em contexto comercial e público atendido.
              </p>
              <Link
