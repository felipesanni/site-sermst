        ...
        <FadeIn direction="up" delay={0.09}>
          <div className="mb-14 grid gap-6 lg:grid-cols-2">
            ...
            <div className="rounded-[2rem] border border-slate-200 bg-white p-8 shadow-sm">
              ...
              <h2 className="text-3xl font-black text-brand-900 md:text-4xl">
                Valor do exame toxicológico CNH
              </h2>
              <p className="mt-4 text-lg font-medium leading-relaxed text-slate-700">
                Para quem quer entender preço, público atendido e o que vale conferir antes de entrar em contato.
              </p>
              <Link
                href="/saude/valor-exame-toxicologico-cnh"
                className="btn-primary-safe mt-6 inline-flex"
              >
                Ler guia de valor
                <ArrowRight className="h-4 w-4" />
        ...
        <FadeIn direction="up" delay={0.1}>
          <div className="mb-14 grid gap-6 lg:grid-cols-2">
            <div className="rounded-[2rem] border border-slate-200 bg-white p-8 shadow-sm">
              ...
              <h2 className="text-3xl font-black text-brand-900 md:text-4xl">
                Onde fazer audiometria ocupacional em São Paulo
              </h2>
              <p className="mt-4 text-lg font-medium leading-relaxed text-slate-700">
                Um guia para quem procura clínica de audiometria no centro de São Paulo, com contexto ocupacional e estrutura para audiometria tonal.
              </p>
              <Link
                href="/saude/onde-fazer-audiometria-ocupacional-sao-paulo"
                className="btn-primary-safe mt-6 inline-flex"
              >
                Ler guia de localização
                <ArrowRight className="h-4 w-4" />
            ...
            <div className="rounded-[2rem] border border-slate-200 bg-white p-8 shadow-sm">
              ...
              <h2 className="text-3xl font-black text-brand-900 md:text-4xl">
                Audiometria ocupacional e audiometria tonal
              </h2>
              <p className="mt-4 text-lg font-medium leading-relaxed text-slate-700">
                Página principal do serviço para empresas que precisam encaixar o exame no ASO, no PCMSO e na rotina operacional com mais clareza.
              </p>
              <Link
