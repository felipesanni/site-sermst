...
const partnerPortes = [
  { v: 'ate-50-clientes', l: 'Até 50 empresas na carteira' },
  { v: '51-200-clientes', l: 'De 51 a 200 empresas' },
  { v: '201-500-clientes', l: 'De 201 a 500 empresas' },
  { v: '500-mais-clientes', l: 'Mais de 500 empresas' },
];

const partnerDores = [
  { v: 'parceria-contadores', l: 'Quero conhecer o programa de parceria' },
  { v: 'comissao-indicacao', l: 'Quero entender a comissão por indicação' },
  { v: 'sst-clientes', l: 'Tenho clientes que precisam de SST' },
...
export function LeadForm({ variant = 'default' }: LeadFormProps) {
  ...
  async function onSubmit(e: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      // Dispara um único evento proprietário para GTM/GA4 e o Lead do Meta Pixel
