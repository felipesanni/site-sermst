...
export function BlockbusterArticle({
  ...
  const articleSchema = pageUrl
    ? {
        ...
        author: { '@type': 'Organization', name: 'SERMST', url: 'https://sermst.com.br' },
        publisher: {
          '@type': 'Organization',
          name: 'SERMST',
  ...
  return (
    <main className="min-h-screen bg-white">
            ...
            <FadeIn direction="up">
              <div className="mt-4">
                <div className="mb-6 flex items-center gap-3">
                  ...
                  <h2 className="text-xl font-black text-brand-900 uppercase tracking-widest text-sm">
      ...
      <section className="relative overflow-hidden bg-brand-900 py-20 text-white">
        <div className="absolute inset-0 bg-[linear-gradient(to_right,#80808012_1px,transparent_1px),linear-gradient(to_bottom,#80808012_1px,transparent_1px)] bg-[size:24px_24px]" />
        <div className="absolute bottom-0 right-0 h-[400px] w-[400px] rounded-full bg-accent-pink/20 blur-[100px]" />
        <div className="relative z-10 max-w-[900px] mx-auto px-6 lg:px-8 text-center">
          <FadeIn direction="up">
            <span className="mb-4 inline-block rounded-full border border-accent-pink/30 bg-accent-pink/10 px-4 py-1.5 text-xs font-black uppercase tracking-[0.2em] text-accent-pink">
              Próximo passo
            </span>
            <h2 className="mb-5 text-3xl font-black leading-tight md:text-5xl">{cta.title}</h2>
            <p className="mx-auto mb-10 max-w-2xl text-xl leading-relaxed text-slate-300">{cta.desc}</p>
            <Link
