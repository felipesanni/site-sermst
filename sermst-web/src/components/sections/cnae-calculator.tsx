    ...
    <div className={`mx-auto mt-10 max-w-3xl rounded-[2.5rem] border-2 ${cfg.border} ${cfg.bg} p-8 shadow-sm`}>
      ...
      <div className="mb-6 grid gap-4 sm:grid-cols-2">
        <div className="rounded-2xl border border-white/60 bg-white/70 p-5">
          <p className="mb-1 text-[11px] font-black uppercase tracking-wider text-slate-500">Referência inicial de RAT</p>
      ...
      <section className="overflow-hidden bg-slate-50 py-20">
        <div className="mx-auto w-full max-w-[1280px] px-6">
          <FadeIn direction="up">
            ...
            <div className="mx-auto mb-6 max-w-2xl rounded-2xl border border-slate-200 bg-white px-5 py-4 shadow-sm">
