...
export function CnaeTable({ data }: CnaeTableProps) {
  ...
  return (
    <div className="not-prose space-y-6">
      ...
      <div className="rounded-2xl border border-blue-200 bg-blue-50 p-5 flex flex-col sm:flex-row sm:items-center gap-4">
        <div className="flex-1 min-w-0">
          <p className="text-sm font-black text-blue-900">
            A tabela mostra o grau de risco. A Calculadora mostra o que fazer com ele.
          </p>
          <p className="mt-1 text-xs text-blue-700">
            Digite o CNPJ ou o código CNAE e veja RAT, obrigação de CIPA, SESMT, periodicidade de exames e NRs aplicáveis ao setor — grátis, sem cadastro.
          </p>
        </div>
        <Link
          href={CALC_URL}
      ...
      <div className="rounded-xl border border-slate-200 bg-slate-50 p-4 flex flex-col sm:flex-row sm:items-center gap-3">
        <p className="flex-1 text-sm text-slate-700">
          <span className="font-bold">Encontrou o código?</span> Agora descubra as obrigações reais da sua empresa — CIPA, SESMT, RAT e NRs do setor.
        </p>
        <Link
          href={CALC_URL}
